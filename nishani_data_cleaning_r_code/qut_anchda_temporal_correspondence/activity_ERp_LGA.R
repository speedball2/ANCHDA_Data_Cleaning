...
#---------------------------------------
origin_folder_path_base <- "./data/ERP_LGA/"

destination_folder_path_base <- "./data/ERP_LGA_TC/"

base_name <- c("ABS_ERP_181_ERP_LGA_2017_2021_ASGS2021_single_year")
...
for(i in 1:length(base_name)){
  ...
  for(j in 1:length(GEO_TYPE)){
    ...
    write.csv(new_data, paste0(destination_folder_path_base,"ABS_ERP_181_ERP_LGA.csv"), row.names = FALSE)
