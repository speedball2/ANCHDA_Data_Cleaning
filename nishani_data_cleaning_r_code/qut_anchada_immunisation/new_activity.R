...
names(table_new)[which(names(table_new)== "Age Group")] <- "age_dtp_immunised_AIR"
names(table_new)[which(names(table_new)== var_name)] <- "p"
names(table_new)[which(names(table_new)== "Year")] <- "calendar_year"

table_new$age_dtp_immunised_AIR[which(table_new$age_dtp_immunised_AIR == "1 Year olds")] <- "1 year"

table_new$age_dtp_immunised_AIR[which(table_new$age_dtp_immunised_AIR == "2 Year olds")] <- "2 years"

table_new$age_dtp_immunised_AIR[which(table_new$age_dtp_immunised_AIR == "5 Year olds")] <- "5 years"
