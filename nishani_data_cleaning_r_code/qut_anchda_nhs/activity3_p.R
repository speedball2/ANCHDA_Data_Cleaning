...
table_13_1 <- main_function(nutrition_categories_children, indicator_name, filenames, "Table 17.3", "A7:F31", 7, 1, "\"#\"#,##0.0",  NULL, 1, "p", "YES", "persons")
...
table_13_1 <- main_function(nutrition_categories_children, indicator_name, filenames, "Table 17.3", "A7:F36", 7, 1, "\"#\"#,##0.0",  NULL, 1, "p", "YES", "persons")
...
table_13_1 <- main_function(nutrition_categories_children, indicator_name, filenames, "Table 17.3", "A7:F55", 7, 1, "\"#\"#,##0.0",  NULL, 1, "p", "YES", "persons")
table_13_5 <- main_function(nutrition_categories_children, indicator_name, filenames, "Table 17.3", "A7:F115", 7, 101, "\"#\"#,##0.0",  NULL, 1, "p", "YES", "males")
table_13_9 <- main_function(nutrition_categories_children, indicator_name, filenames, "Table 17.3", "A7:F182", 7, 168, "\"#\"#,##0.0",  NULL, 1, "p", "YES", "females")
