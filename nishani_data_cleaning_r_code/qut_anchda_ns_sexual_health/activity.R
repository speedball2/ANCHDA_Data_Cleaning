...
#RSE AT SCHOOL
sexual_health_dat_extraction(sex_health_data, "n_received_RSE_school", "p_received_RSE_school", 220, 221 ,1, site, sie_code, "./output/NSSHS_1151_RSE_AT_SCHOOL_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")


#could get a STI (AA, AB)
sexual_health_dat_extraction(sex_health_data, "n_believe_get_STI", "p_believe_get_STI", 27, 28 ,1, site, sie_code, "./output/NSSHS_1151_GET_STI_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")

#‘students reporting they think most people their age use condoms (AD, AE)

sexual_health_dat_extraction(sex_health_data, "n_think_most_people_use_condoms", "p_think_most_people_use_condoms", 30, 31 ,1, site, sie_code, "./output/NSSHS_1151_CONDOM_USE_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")
...
sexual_health_dat_extraction(sex_health_data, "n_had_discussions_prior_use_condom", "p_had_discussions_prior_use_condom", 56, 57 ,1, site, sie_code, "./output/NSSHS_1151_DISCUSSION_USE_CONDOM_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")


#students who had discussions related to protecting sexual health prior to having sex: avoiding pregnancy (BJ, BK)

sexual_health_dat_extraction(sex_health_data, "n_had_discussions_prior_avoid_pregnancy", "p_had_discussions_prior_avoid_pregnancy", 62, 63 ,1, site, sie_code, "./output/NSSHS_1151_DISCUSSION_AVOIDING_PREGNANCY_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")

#students who had discussions related to protecting sexual health prior to having sex:  avoiding STIs and HIV (BG, BH)

sexual_health_dat_extraction(sex_health_data, "n_had_discussions_prior_avoid_STIs_HIV", "p_had_discussions_prior_avoid_STIs_HIV", 59, 60 ,1, site, sie_code, "./output/NSSHS_1151_DISCUSSION_AVOIDING_STI_HIV_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")

#---------------------------

#students reporting feeling pressure from a partner (BO + BQ, BP + BR)

sexual_health_dat_extraction(sex_health_data, "n_pressure_partner", "p_pressure_partner", c(67,69), c(68,70) ,2, site, sie_code, "./output/NSSHS_1151_FEELING_PRESSURE_PARTNER_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")


#students reporting feeling pressure from peers (BV + BX, BW + BY)

sexual_health_dat_extraction(sex_health_data, "n_pressure_peers", "p_pressure_peers", c(74,76), c(75,77) ,2, site, sie_code, "./output/NSSHS_1151_FEELING_PRESSURE_PEERS_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")
...
sexual_health_dat_extraction(sex_health_data, "n_info_source_doctor_gp", "p_info_source_doctor_gp", 217, 218 ,1, site, sie_code, "./output/NSSHS_1151_COMMON_SOURCE_DOCTOR_knowledge_and_skills_on_safe_sexual_and_reproductive_health_behaviours_state_level.csv")
