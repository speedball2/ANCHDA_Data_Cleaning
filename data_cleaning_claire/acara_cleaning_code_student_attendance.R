...
path_out = "./output/ACARA/attendance_rate"
...
for (i in seq_along(lga_combined)) {
  ...
  # Construct file name
  file_name <- paste0("acara_472_attendance_rate_", school_type, "_", school_sector , "_LGA.csv")
...
for (i in seq_along(sa2_combined)) {
  ...
  school_sector <- unique(lga_combined[[i]]$school_sector)
  # Construct file name
  file_name <- paste0("acara_472_attendance_rate_", school_type, "_", school_sector, "_SA2.csv")
...
for (i in seq_along(sa3_combined)) {
  ...
  # Construct file name
  file_name <- paste0("acara_472_attendance_rate_", school_type, "_", school_sector, "_SA3.csv")
