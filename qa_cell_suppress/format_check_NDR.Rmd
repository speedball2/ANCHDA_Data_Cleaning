---
title: "format check and cell suppression on NDR data"
...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/ndr//") #change this path if you copy this 
...
```{r}
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/ndr/" #change this path
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/ndr/cell_suppressed/"#change this path
```
run this code to...
...
for (file in csv_files) {
 ...
 # Apply cell suppression
  df[df[, 5] > 0 & df[, 5] < 5 & !is.na(df[, 5]), -c(1:4)] <- 9999999
