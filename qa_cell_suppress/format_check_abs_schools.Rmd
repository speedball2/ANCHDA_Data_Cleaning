...
for (file in csv_files) {
  ...
  if ("n_full_time_student" %in% colnames(df)) {
    ...
    df[df$n_full_time_student > 0 & df$n_full_time_student < 5 & !is.na(df$n_full_time_student), !(colnames(df) %in% c("STE_CODE16", "calendar_year", "sex", "age_group", "school_grade", "affiliation_abs_schools"))] <- 9999999
  } else {
  ...
  if ("n_part_time_student" %in% colnames(df)) {
    ...
    df[df$n_part_time_student > 0 & df$n_part_time_student < 5 & !is.na(df$n_part_time_student), !(colnames(df) %in% c("STE_CODE16", "calendar_year", "sex", "age_group", "school_grade", "affiliation_abs_schools"))] <- 9999999
  } else {
