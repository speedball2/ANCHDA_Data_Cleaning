---
title: "format check and cell suppression on ABS School data"
...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_schools/") #change this path if you copy this 
...
```{r}
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_schools/" #change this path
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_schools/cell_suppressed/"#change this path
```
run this code to...
...
for (file in csv_files) {
  ...
  if ("uncertainty" %in% colnames(df)) {
    cat("<p><strong>Note:</strong> The file ", basename(file), " contains an 'uncertainty' column. Make sure to modify the code to apply cell suppression where uncertainty is high.</p>")
  } else {
    cat("<p>You don't have to worry about cell suppression on 'uncertainty' in", basename(file), "</p>")
  }
}
```
Run this code to...
...
for (file in csv_files) {
  ...
  if (length(num_cols) > 0) {
    cat("<h4>For file ", basename(file), ", check values in the following columns for cell suppression:</h4>")
    cat("<ul>")
    for (col in num_cols) {
      cat("<li>", col, "</li>")
    }
    ...
    cat("<p>You don't have to worry about cell suppression in any numeric columns in", basename(file), "</p>")
  }
}
