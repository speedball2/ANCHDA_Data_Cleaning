...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/aihw_child_protection/") #change this path if you copy this 
...
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/aihw_child_protection/"
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/aihw_child_protection//cell_suppressed/"
```
...
for (file in csv_files) {
  ...
  # Find the column index of the 5th column
  column_index <- min(5, ncol(df))
  
  # Apply cell suppression to the 5th column and columns to the right
  if (!is.na(column_index) && column_index <= ncol(df)) {
    df[df[, column_index] %in% 1:4, column_index:ncol(df)] <- 9999999
  }
