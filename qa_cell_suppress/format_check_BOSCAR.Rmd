---
title: "format check and cell suppression on BOCSAR data"
...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/BOCSAR/") #change this path if you copy this 
...
for (file in csv_files) {
  if (!grepl("_STE|_SA3|_SA2|_SA4|_national|_Australia|_LGA", file)) {
...
```{r}
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/BOCSAR/" #change this path
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/BOCSAR/cell_suppressed/"#change this path
```
run this code to...
...
```
#no need to suppress rows here - already done by the custodian
