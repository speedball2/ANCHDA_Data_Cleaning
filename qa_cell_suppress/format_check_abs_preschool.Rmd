...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_preschool") #change this path if you copy this 
...
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_preschool//"
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/abs_preschool//cell_suppressed/"
```
...
for (file in csv_files) {
  ...
  if ("n_children_attending_preschool" %in% colnames(df)) {
    # Apply cell suppression
    df[df[,"n_children_attending_preschool"] %in% 0:4 & !is.na(df[,"n_children_attending_preschool"]), -c(1:4)] <- 9999999
  } else {
    # Print a message to indicate that the column was not found
    cat("Skipping file", file, "because it does not contain the n_children_attending_preschool column.\n")
  }
