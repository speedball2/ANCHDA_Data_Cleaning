...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/YJNMDS/") #change this path if you copy this 
...
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/YJNMDS/"
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/YJNMDS//cell_suppressed/"
```
...
for (file in csv_files) {
  ...
  df[df[, 6] < 5 & !is.na(df[, 6]), -c(1:5)] <- 9999999 #here i used column position 6th column to batch cell suppress
