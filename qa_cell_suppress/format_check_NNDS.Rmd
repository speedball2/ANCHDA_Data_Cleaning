...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/NNDSS/") #change this path if you copy this 
...
for (file in csv_files) {
  ...
  df[, 5] <- ifelse(df[, 5] < 5, 9999999, df[, 5]) #modify this line if your n values are not in the 5th column
