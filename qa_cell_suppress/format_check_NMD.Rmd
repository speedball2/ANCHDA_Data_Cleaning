---
title: "format check and cell suppression on NMD School data"
...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/nmd/") #change this path if you copy this 
...
for (df_name in names(df_list)) {
  ...
  cat(paste("Number of rows:", nrow(df), "\n"))
...
```{r}
input_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/nmd/"
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/nmd/cell_suppressed/"
```
...
for (file in csv_files) {
  ...
  if (num_cols > 4) {
    df[, 5:num_cols] <- lapply(df[, 5:num_cols], function(x) replace(x, is.na(x), 9999999))
  }
