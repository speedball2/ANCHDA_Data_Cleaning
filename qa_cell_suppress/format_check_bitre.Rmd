...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/bitre//") #change this path if you copy this 
...
output_dir <- "C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/bitre//cell_suppressed/"
```
...
for (file in csv_files) {
  ...
  if ("n_fatally_injured_in_road_accident" %in% colnames(df) || "rolling_average_fatally_injured_in_road_accident" %in% colnames(df)) {
    suppressed_cols <- c("n_fatally_injured_in_road_accident", "rolling_average_fatally_injured_in_road_accident")
    ...
    cat("Skipping file", file, "because it does not contain the n_fatally_injured_in_road_accident or rolling_average_fatally_injured_in_road_accident column.\n")
  }
