...
setwd("C:/Users/00095998/OneDrive - The University of Western Australia/acwa_temp/bitre/")
...
for (file in csv_files) {
  ...
  if ("n_fatally_injured_in_road_accident" %in% colnames(df)) {
    # Apply cell suppression
    df[df[,"n_fatally_injured_in_road_accident"] <5 & !is.na(df[,"n_fatally_injured_in_road_accident"]), -c(1:4)] <- 9999999
  } else {
    # Print a message to indicate that the column was not found
    cat("Skipping file", file, "because it does not contain the n_fatally_injured_in_road_accident column.\n")
  }
...
>>>>>>> 5bcb08c3ec83cb6ab61b2e840a575e03d133a22a
