...
TB_Census_cleaning_fn_individual(data_file_base = "census_religion", data_item_name ="religion", calendar_year=2006,code_or_name = "code", census_tag = "RELP", census_filter_col_name = "relp_religious_affiliation")
...
TB_Census_cleaning_fn_individual(data_file_base = "census_religion", data_item_name ="religion", calendar_year=2016,code_or_name = "name", census_tag = "RELP", census_filter_col_name = "relp_religious_affiliation")
...
TB_Census_cleaning_fn_individual(data_file_base = "census_religion", data_item_name ="religion", calendar_year=2021,code_or_name = "name", census_tag = "RELP", census_filter_col_name = "relp_religious_affiliation")
