...
TB_Census_cleaning_fn(data_file_base = "census_year12", data_item_name ="completed_year12", calendar_year=2006,code_or_name = "code")
...
TB_Census_cleaning_fn(data_file_base = "census_year12", data_item_name ="completed_year12", calendar_year=2011,code_or_name = "name")
...
TB_Census_cleaning_fn(data_file_base = "census_year12", data_item_name ="completed_year12", calendar_year=2016,code_or_name = "name")
...
TB_Census_cleaning_fn(data_file_base = "census_year12", data_item_name ="completed_year12", calendar_year=2021,code_or_name = "name")
