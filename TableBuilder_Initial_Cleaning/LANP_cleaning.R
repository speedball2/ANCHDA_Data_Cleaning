...
TB_Census_cleaning_fn_individual(data_file_base = "census_LANP", data_item_name ="language_spoken_at_home", calendar_year=2006,code_or_name = "code", census_tag = "LANP", census_filter_col_name = "lanp_language_spoken_at_home",claire_redownload = T)
...
TB_Census_cleaning_fn_individual(data_file_base = "census_LANP", data_item_name ="language_spoken_at_home", calendar_year=2011,code_or_name = "code", census_tag = "LANP", census_filter_col_name = "lanp_language_spoken_at_home",claire_redownload = T)
...
TB_Census_cleaning_fn_individual(data_file_base = "census_LANP", data_item_name ="language_spoken_at_home", calendar_year=2016,code_or_name = "code", census_tag = "LANP", census_filter_col_name = "lanp_language_spoken_at_home",claire_redownload = T)
...
TB_Census_cleaning_fn_individual(data_file_base = "census_LANP", data_item_name ="language_spoken_at_home", calendar_year=2021,code_or_name = "code", census_tag = "LANP", census_filter_col_name = "lanp_language_spoken_at_home",claire_redownload = T)
