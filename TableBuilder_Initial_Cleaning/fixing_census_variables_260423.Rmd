...
fixing_oneparent <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_one_parent_",geog,".csv"))
  
  
  names(temp_data)[3] <- "n_of_one_parent_families_with_children_under_15_years_old"
...
fixing_yr12 <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_year12_",geog,".csv"))
  
  names(temp_data)[5] <- "n_young_people_with_year_12_or_equivalent_highest_year_of_school_completed"
...
fixing_volunteer <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_volunteer_",geog,".csv"))
  
  names(temp_data)[5] <- "n_young_people_doing_unpaid_voluntary_work"
...
fixing_LANP <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_LANP_",geog,".csv"))
...
fixing_english <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_english_notwell_",geog,".csv"))
  

  temp_data <- temp_data %>% group_by_at(c(1,2,3,6)) %>% mutate(new_vals = sum(n_children_and_young_people_who_speak_english_not_well_or_not_at_all))
  ...
  names(temp_data)[5] <- "n_children_and_young_people_who_speak_english_not_well_or_not_at_all"
...
fixing_country <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_countryofbirth_",geog,".csv"))
...
fixing_religion <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_religion_",geog,".csv"))
...
fixing_core <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_core_activity_need_assistance_",geog,".csv"))
  
  
  temp_data <- temp_data %>% filter(assnp_core_activity_need_for_assistance=="Has need for assistance with core activities")
  
  names(temp_data)[5] <- "n_children_and_young_people_with_core_activity_need_for_assistance"
...
fixing_ssh <- function(geog){
  ...
  temp_data <- read.csv(paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/old_column_names/census_same_sex_couple_",geog,".csv"))
  ...
  temp_data <- temp_data %>% group_by_at(c(1,5)) %>% mutate(new_vals = sum(same_sex_couple_children))
  
  temp_data[,4] <- temp_data[,6]
  
  names(temp_data)[4] <- "n_same_sex_couples_with_one_or_more_dependent_children"
  ...
  write.csv(temp_data, file = paste0("/Users/Current/OneDrive - Queensland University of Technology/General - ACWA_QUT/Data_Collections_READY_FOR_QA/census/ABS_census_XYZ_same_sex_parents_with_dependent_children_",geog,".csv"), row.names = F)
}
