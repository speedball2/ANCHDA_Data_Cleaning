...
# User inputs:
data_file_base <- "census_unemployment"                               # Base file name for datasets e.g. census_unemployment
VAR_NAME <- "labour_force_status"                                  # Name of the input variable column.
GEO_TO <- "LGA_CODE_2016"                                       # Target geography column
FILTER_VARS <- c("age_group", "sex", "lfhrp_labour_force_status")                            # Name of original data set filter variable(s).
