...
VAR_NAME <- #"english_not_well"                                  # Name of the input variable column.
...
#===================================================
# Applying - English spoken not well
...
FILTER_VARS <- c("age_group", "sex","ENGLP Proficiency in Spoken English")                            # Name of original data set filter variable(s).
