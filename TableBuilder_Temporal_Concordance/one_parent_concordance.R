...
# User inputs:
data_file_base <- "census_one_parent"                               # Base file name for datasets e.g. census_one_parent
VAR_NAME <- "one_parent_children"                                  # Name of the input variable column.
GEO_TO <- "LGA_CODE_2016"                                       # Target geography column
FILTER_VARS <- c("fmcf_family_composition")                            # Name of original data set filter variable(s).
