...
# User inputs:
data_file_base <- "census_same_sex_couple"                               # Base file name for datasets e.g. census_same_sex_couple
VAR_NAME <- "same_sex_couple_children"                                  # Name of the input variable column.
GEO_TO <- "LGA_CODE_2016"                                       # Target geography column
FILTER_VARS <- c("sscf_same_sex_couple_indicator","cdcf_count_of_dependent_children_in_family")                            # Name of original data set filter variable(s).
