# Cleaning code for TableBuilder Data - CENSUS - one_parent
...
one_parent_cleaning_fn <- function(data_file_base, data_item_name, calendar_year,code_or_name){
...
one_parent_cleaning_fn(data_file_base = "census_one_parent", data_item_name ="one_parent", calendar_year=2006,code_or_name = "code")
...
one_parent_cleaning_fn(data_file_base = "census_one_parent", data_item_name ="one_parent", calendar_year=2011,code_or_name = "code")
...
one_parent_cleaning_fn(data_file_base = "census_one_parent", data_item_name ="one_parent", calendar_year=2016,code_or_name = "code")
...
one_parent_cleaning_fn(data_file_base = "census_one_parent", data_item_name ="one_parent", calendar_year=2021,code_or_name = "code")
