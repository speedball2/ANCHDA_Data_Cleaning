...
temporal_concordance_census_fn <- function(origin_folder_path_base,destination_folder_path_base,data_file_base,VAR_NAME,GEO_TO,FILTER_VARS,GEO_TYPE,GEO_TYPE_2006){
  ...
  df_2011$filters_combo <- paste(df_2011[,FILTER_VARS[1]],df_2011[,FILTER_VARS[2]],df_2006[,FILTER_VARS[3]],sep="_")
  ...
  df_2021$filters_combo <- paste(df_2021[,FILTER_VARS[1]],df_2021[,FILTER_VARS[2]],df_2006[,FILTER_VARS[3]],sep="_")
