...
cleaning <- function(path, sht, range, col, i, m, f, fem, mal, fem2, mal2, full){
...
df1 <- cleaning("Client File-ERP-LS005201.xlsx", 2, "A9:BA36681", T, i, m, f, fem, mal, fem2, mal2, full)
